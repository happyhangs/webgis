  ...
  return (
    <div className="toolbar">
      ...
      <div className="toolbar-group">
        ...
        <button className="toolbar-btn" onClick={handleShiftCoords} title="将全部标注坐标转为所选坐标系">
